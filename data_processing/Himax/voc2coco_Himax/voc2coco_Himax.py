...
def main():
    ...
    xml_path = f'/home/owenserver/storage/Datasets/VOC_format_Himax_{s_device}_{datatype}/{datatype}/annotation_xml'
    json_dir = f'/home/owenserver/storage/Datasets/VOC_format_Himax_{s_device}_{datatype}/{datatype}/annotation'
    json_filename = f'gaze_{s_device}_{datatype}.json'
