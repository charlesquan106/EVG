...
def addAnnoItem(image_id, gazepoint_list, gazeOrigin_list, gazeTarget_list,\
            camera_list, monitorPose_list, screenSize_list,faceBbox_list):
...
def main():
    ...
    xml_path = f'/home/owenserver/storage/Datasets/VOC_format_Himax_{s_device}_rgb_{datatype}/{datatype}/annotation_xml'
    json_dir = f'/home/owenserver/storage/Datasets/VOC_format_Himax_{s_device}_rgb_{datatype}/{datatype}/annotation'
    json_filename = f'gaze_Himax_{s_device}_{datatype}.json'
