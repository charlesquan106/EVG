...
def ImageProcessing_Person(person_dir, output_img_dir, output_xml_dir, person, person_device_info):
    ...
    for index, frame in enumerate(images_list):
        ...
        writer.addGaze_GazeCapture(int(x_px), int(y_px) , gaze_origin, gaze_target\
...
def main():
    ...
    output_dir = f'/home/owenserver/storage/Datasets/VOC_format_GazeCapture_{s_device}_{datatype}'
