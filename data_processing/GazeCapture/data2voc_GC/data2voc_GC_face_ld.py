...
def expand_bbox(img, X, Y, W, H , expand_ratio = 1.2 ):
...
def ImageProcessing_Person(person_dir, output_img_dir, output_xml_dir, person, person_device_info):
    ...
    for index, frame in enumerate(images_list):
        ...
        bbox = expand_bbox(img, face_located["X"][index], face_located["Y"][index], 
                        face_located["W"][index], face_located["H"][index],1.2)
        ...
        writer.addGaze_GazeCapture_ld(int(x_px), int(y_px) , gaze_origin, gaze_target\
...
def main():
    ...
    # dataset_dir = f'/home/owenserver/storage/Datasets/GazeCapture_test_train'
    # output_dir = f'/home/owenserver/storage/Datasets/VOC_format_GazeCapture_{s_device}_{datatype}_ld'
    output_dir = f'/home/owenserver/Python/Gaze_DataProcessing/GazeCapture/test_folder/VOC_format_GazeCapture_{s_device}_{datatype}_ld'
