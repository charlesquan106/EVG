...
def main():
    ...
    xml_path = f'/home/owenserver/storage/Datasets/VOC_format_GazeCapture_{s_device}_{datatype}_ld/{datatype}/annotation_xml'
    json_dir = f'/home/owenserver/storage/Datasets/VOC_format_GazeCapture_{s_device}_{datatype}_ld/{datatype}/annotation'
