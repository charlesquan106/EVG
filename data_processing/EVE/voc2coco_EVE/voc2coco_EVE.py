...
def main():
    ...
    xml_path = f'/home/owenserver/storage/Datasets/VOC_format_EVE_Data_test_s/{datatype}/annotation_xml'
    json_dir = f'/home/owenserver/storage/Datasets/VOC_format_EVE_Data_test_s/{datatype}/annotation'
