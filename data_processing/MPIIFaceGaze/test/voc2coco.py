...
def addAnnoItem(image_id, gazepoint_list, camera_list, monitorPose_list, screenSize_list):
        ...
        for elem in root:
            ...
            for subelem in elem:
                ...
                if obejct_done:
                    ...
                    addAnnoItem( current_image_id, gazepoint_list, camera_list, monitorPose_list, screenSize_list)
...
def main():
    ...
    xml_path = f'/home/owenserver/storage/Datasets/VOC_format_MPIIFaceGaze_train_one_person/annotation_xml'
    
    json_dir = '/home/owenserver/storage/Datasets/VOC_format_MPIIFaceGaze_train_one_person/annotation'
    json_filename = 'gaze_train.json'
