    ...
    for path in sorted(data_person_dir.glob('*')):
        ...
        if (path.name == person_id_file ):
            ...
            for _, row in df.iterrows():
                ...
                writer.addGaze_MPIIFaceGaze(row.x_px, row.y_px, gaze_origin, gaze_target\
...
def main():
    ...
    # dataset_dir = f'/home/owenserver/storage/Datasets/MPIIFaceGaze/MPIIFaceGaze'
    # output_xml_dir = f'/home/owenserver/Python/Gaze_DataProcessing/MPIIFaceGaze/test_folder/VOC_format_MPIIFaceGaze_{datatype}_p{val_id:02}/annotation_xml'
    # output_img_dir = f'/home/owenserver/Python/Gaze_DataProcessing/MPIIFaceGaze/test_folder/VOC_format_MPIIFaceGaze_{datatype}_p{val_id:02}/image'
    # output_logger_dir = f'/home/owenserver/Python/Gaze_DataProcessing/MPIIFaceGaze/test_folder/VOC_format_MPIIFaceGaze_{datatype}_p{val_id:02}/logger.txt'
