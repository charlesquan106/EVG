...
def main():
    ...
    parser.add_argument('-v','--val_id', type=int, required=True)
    args = parser.parse_args()
    datatype = args.datatype 
    val_id = args.val_id
    
    xml_path = f'/home/owenserver/storage/Datasets/VOC_format_MPIIFaceGaze_{datatype}_p{val_id:02}/annotation_xml' 
    json_dir = f'/home/owenserver/storage/Datasets/VOC_format_MPIIFaceGaze_{datatype}_p{val_id:02}/annotation'
    # xml_path = f'/home/owenserver/Python/Gaze_DataProcessing/MPIIFaceGaze/test_folder/VOC_format_MPIIFaceGaze_{datatype}_p{val_id:02}/annotation_xml' 
    # json_dir = f'/home/owenserver/Python/Gaze_DataProcessing/MPIIFaceGaze/test_folder/VOC_format_MPIIFaceGaze_{datatype}_p{val_id:02}/annotation'
    
    json_filename = f'gaze_{datatype}_p{val_id:02}.json'
