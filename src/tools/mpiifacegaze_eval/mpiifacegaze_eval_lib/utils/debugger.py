...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    elif num_classes == 1 or dataset == 'mpiifacegaze':
      self.names = mpiifacegaze_class_name
  ...
  def add_gaze_point(self, point, cat, conf=1, show_txt=True, img_id='default'):
    ...
    cv2.circle(self.imgs[img_id], (point[0] * self.down_ratio, 
                                   point[1] * self.down_ratio),
                                  5, (255, 255, 255), -1)
    if show_txt:
      cv2.circle(self.imgs[img_id], (point[0], point[1] - cat_size[1] - 2),
                              5, (255, 255, 255), -1)
      cv2.putText(self.imgs[img_id], txt, (point[0], point[1] - 2), 
                  font, 0.5, (0, 0, 0), thickness=1, lineType=cv2.LINE_AA)
