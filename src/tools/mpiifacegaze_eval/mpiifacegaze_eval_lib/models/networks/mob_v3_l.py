...
def _mobilenet_v3(
    ...
    **kwargs: Any,
    ...
    model = MobileNetV3(inverted_residual_setting, last_channel, heads,
        head_conv, **kwargs)
...
def mobilenet_v3_large(
    *,heads, head_conv, weights: Optional[MobileNet_V3_Large_Weights] = None, progress: bool = True, **kwargs: Any
) -> MobileNetV3:
    """
    ...
    return _mobilenet_v3(inverted_residual_setting, last_channel, weights, progress,heads,
        head_conv, **kwargs)

@handle_legacy_interface(weights=("pretrained", MobileNet_V3_Small_Weights.IMAGENET1K_V1))
def mobilenet_v3_small(
    *,heads, head_conv, weights: Optional[MobileNet_V3_Small_Weights] = None, progress: bool = True, **kwargs: Any
) -> MobileNetV3:
    """
...
def get_pose_net(num_layers,heads,head_conv):
  ...
  model = mobilenet_v3_large( heads = heads ,head_conv=head_conv,weights=weights)
  
  
  url = model_urls['MobileNet_V3_Large']
