...
file_params = [
    ...
    "ctdet_gazeface --exp_id gaze_gc_resdcnface_18_all_f05 --arch resdcnface_18 --dataset gazecapture --num_epochs 70 --lr_step 45,60 --vp_pixel_per_mm 5 --camera_screen_pos --vp_h 2400 --vp_w 2400  --face_hm_head --face_hm_weight 0.5 --val_intervals 2",
    "ctdet_gazeface --exp_id gaze_gc_resdcnface_18_all_f2 --arch resdcnface_18 --dataset gazecapture --num_epochs 70 --lr_step 45,60 --vp_pixel_per_mm 5 --camera_screen_pos --vp_h 2400 --vp_w 2400  --face_hm_head --face_hm_weight 2 --val_intervals 2"   ,
    "ctdet_gazeface --exp_id gaze_gc_resdcnface_18_all_f025 --arch resdcnface_18 --dataset gazecapture --num_epochs 70 --lr_step 45,60 --vp_pixel_per_mm 5 --camera_screen_pos --vp_h 2400 --vp_w 2400  --face_hm_head --face_hm_weight 0.25 --val_intervals 2" ,
