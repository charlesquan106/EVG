...
file_params = [
    ...
    "ctdet_gaze --exp_id gaze_resdcn18_csp_kr_resize_p05_test --arch resdcn_18 --dataset mpiifacegaze --num_epochs 70  --lr_step 45,60 --keep_res --vp_h 2100 --vp_w 3360 --resize_raw_image --resize_raw_image --resize_raw_image_h 360 --resize_raw_image_w 640  --camera_screen_pos --vp_pixel_per_mm 5 --not_data_train_val_exclude --data_train_person_id  5 --data_test_person_id  5",
